...
CREATE TABLE IF NOT EXISTS transaction_splits (
    ...
    member_id UUID REFERENCES ledger_members (id) ON DELETE CASCADE, -- Optional link to actual member
    name VARCHAR(50) NOT NULL, -- Name used for the split (can be legacy name or member alias)
